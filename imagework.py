...
def open_AIA_fits(filename, is_magnetogram = False):
        ...
        if is_magnetogram == True:
            imgAIA = np.flip(imgAIA, 0)
            imgAIA = np.flip(imgAIA, 1)
...
if mag == True:
        ...
        imgAIA, delt_pix_AIA, centre_AIA = open_AIA_fits(filename_AIA, True)
...
for i in cadres:
        ...
        extentI    = [ -centre_I[0] * delt_pix_I[0] + shiftxI, centre_I[0] * delt_pix_I[0] + shiftxI, -centre_I[1] * delt_pix_I[1] + shiftyI, centre_I[1] * delt_pix_I[1] + shiftyI]
        extentV    = [ -centre_I[0] * delt_pix_I[0] + shiftxV, centre_I[0] * delt_pix_I[0] + shiftxV, -centre_I[1] * delt_pix_I[1] + shiftyV, centre_I[1] * delt_pix_I[1] + shiftyV]
